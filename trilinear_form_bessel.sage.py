...
# This file was *autogenerated* from the file trilinear_form_bessel.sage
from sage.all_cmdline import *   # import sage library

_sage_const_5 = Integer(5); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_3 = Integer(3)# Combine are the representations here and calculate the trilinear form
...
induced2 = goodCharsB[_sage_const_3 ]
induced3 = goodCharsB[_sage_const_5 ]
...
def besselFn(g, charB):
    ...
    bElem = G(MS([[b - a * d / c, a], [_sage_const_0 , c]]))
    uElem = G(MS([[_sage_const_1 , d / c], [_sage_const_0 , _sage_const_1 ]]))

    return charB(bElem) * psi(d / c)

# Returns the vector in Vinduced of the bessel fn
def besselFnVector(charB):
    sol = Vinduced([_sage_const_0 ] * (q+_sage_const_1 ))
    for i in range(_sage_const_0 , len(cosetRepsB)):
...
def whittaker(g, char):
    ...
    for z in K:
        ...
        s = s + besselFn(inp, char) * (_sage_const_1  / psi(z))
    return s

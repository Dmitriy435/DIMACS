...
# This file was *autogenerated* from the file trilinear_form_qdim1.sage
from sage.all_cmdline import *   # import sage library

_sage_const_5 = Integer(5); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_0p0000001 = RealNumber('0.0000001')# Combine are the representations here and calculate the trilinear form
...
induced3 = badCharsB[_sage_const_0 ]
...
for i, j, k in cartesian_product((range(q+_sage_const_1 ), range(q+_sage_const_1 ), range(q))):
    v1 = Vinduced.basis()[i]
    v2 = Vinduced.basis()[j]
    v3 = Vqdim3.basis()[k]

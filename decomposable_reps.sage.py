...
_sage_const_3 = Integer(3); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_4 = Integer(4); _sage_const_15 = Integer(15); _sage_const_5 = Integer(5)# Preliminaries
...
vec = liftMap(V2([_sage_const_5 , _sage_const_1 , -_sage_const_2 ]))
print(vec)
g = G([[_sage_const_1 , _sage_const_2 ], [_sage_const_2 , _sage_const_2 ]])
print(g)

...
_sage_const_5 = Integer(5); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_7 = Integer(7)# Combine are the representations here and calculate the trilinear form
...
cusp = nondecomposableChars[_sage_const_7 ]

...
_sage_const_5 = Integer(5); _sage_const_0 = Integer(0); _sage_const_3 = Integer(3); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0p000001 = RealNumber('0.000001'); _sage_const_0p0000001 = RealNumber('0.0000001'); _sage_const_4 = Integer(4); _sage_const_9 = Integer(9); _sage_const_7 = Integer(7)
import csv
...
numInd = _sage_const_0  #For now only working with good chars!
numCus = _sage_const_3  #This is at least 1 for this file
...
reps = [
        ...
        (_sage_const_0 , _sage_const_4 , _sage_const_9 ),
        (_sage_const_1 , _sage_const_1 , _sage_const_2 ),
        (_sage_const_1 , _sage_const_7 , _sage_const_9 ),
...
for rep in reps:
    char1 = nondecomposableChars[rep[_sage_const_0 ]]
    char2 = nondecomposableChars[rep[_sage_const_1 ]]
    char3 = nondecomposableChars[rep[_sage_const_2 ]]
    
    s = triformBasisVecs()
    s.insert(_sage_const_0 , "rho" + str(rep[_sage_const_0 ]) + " rho" + str(rep[_sage_const_1 ]) + " rho" + str(rep[_sage_const_2 ]))
    data.append(s)

...
_sage_const_4 = Integer(4); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_15 = Integer(15); _sage_const_3 = Integer(3); _sage_const_5 = Integer(5); _sage_const_7 = Integer(7)# THIS FILE IS OBSOLETE - DO NOT USE
from mpmath import *
...
print(aL)
print("This is cuspidal char " + str(_sage_const_2 ) + "'s value on generator of L^*")
temp = (nu(aL, nondecomposableChars[_sage_const_2 ])).complex_embedding()
print(temp)
print(arg(temp)*_sage_const_15  / _sage_const_2  / pi)


print()

determinantG = _sage_const_0 
i = _sage_const_0 
for x in K:
...
for u in L:
    if u * conjugateOfL(u) == determinantG:
        ...
        print(arg(nu(u, nondecomposableChars[_sage_const_2 ]).complex_embedding())* _sage_const_15  / _sage_const_2  / pi)
        print()

kappa = e**(_sage_const_2  * pi / _sage_const_15 )
t = -kappa**(-_sage_const_2 ) + kappa**(-_sage_const_5 ) - kappa**_sage_const_7  + kappa**_sage_const_4  + kappa
t = -t / _sage_const_4 
print(t)
...
induced2 = goodCharsB[_sage_const_1 ]
induced3 = goodCharsB[_sage_const_1 ]

#cusp = nondecomposableChars[0]


vec1 = Vinduced.basis()[_sage_const_0 ]
vec2 = Vinduced.basis()[_sage_const_1 ]
vec3 = Vinduced.basis()[_sage_const_2 ]
